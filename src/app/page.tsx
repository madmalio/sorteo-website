  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-900 text-white">
      ...
      <section className="flex max-w-4xl flex-col items-center p-8 text-center">
        <h1 className="pb-2 text-5xl font-bold leading-snug tracking-tight text-transparent md:text-7xl bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-400">
        ...
        <a
          href="/sorteo-v1.0.0-windows.zip" // Links to the file in your 'public' folder
          download
        ...
        <div className="mx-auto max-w-6xl px-8">
          ...
          <div className="mt-16 flex flex-col justify-between gap-12 md:flex-row md:gap-8">
            <div className="flex items-start gap-4">
              <div className="text-6xl font-bold text-gray-700">01</div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="text-6xl font-bold text-gray-700">02</div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="text-6xl font-bold text-gray-700">03</div>
              <div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="border-gray-700 bg-gray-800 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="pt-4 text-gray-400">
              Your download has started. If you find Sorteo useful, please
              consider supporting its development. Every little bit helps!
            </DialogDescription>
          </DialogHeader>
          <a
            href="#" // TODO: Link to your Ko-fi or donation page
            target="_blank"
            rel="noopener noreferrer"
